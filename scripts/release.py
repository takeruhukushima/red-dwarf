...
3. Update `pyproject.yaml` to new version.
4. Commit the changes as "Prepare for release vX.Y.Z"
5. Create a tagged commit and push:
...
8. Publish to PyPI:
    $ uv publish
9. Announce in Polis User Group discord.
